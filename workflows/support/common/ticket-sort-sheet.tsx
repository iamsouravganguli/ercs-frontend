...
interface TicketSortSheetProps {
  open: boolean;
...
export function TicketSortSheet({
  open,
  onOpenChange,
  sorting,
  onSortingChange,
}: TicketSortSheetProps) {
  ...
  const fieldOptions = [
    {
      label: t("support.table.ticket_number") || "Ticket No.",
      value: "ticket_number",
    },
    { label: t("support.table.subject") || "Subject", value: "subject" },
    { label: t("support.table.category") || "Category", value: "category" },
    { label: t("support.table.priority") || "Priority", value: "priority" },
    { label: t("support.table.status") || "Status", value: "status" },
    {
      label: t("support.table.created_at") || "Created At",
      value: "created_at",
    },
    {
      label: t("support.table.updated_at") || "Updated At",
      value: "updated_at",
    },
  ];
        ...
        >
          <CustomSheetHeader className="px-6 py-3 border-b shrink-0 bg-neutral-50/50 dark:bg-neutral-900/50 flex items-center h-[56px]">
            <h2 className="text-lg font-semibold text-foreground">
              {t("support.sort_title") || "Sort Tickets"}
            </h2>
          </CustomSheetHeader>
