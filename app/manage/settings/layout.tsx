...
const nav = [
  ...
  { href: "/manage/settings/security", label: "Security", icon: Shield },
  { href: "/manage/settings/mfa", label: "MFA", icon: KeyRound },
  { href: "/manage/settings/dsc", label: "DSC", icon: Fingerprint },
  { href: "/manage/settings/sessions", label: "Sessions", icon: Monitor },
  {
    href: "/manage/settings/preferences",
    label: "Preferences",
    icon: Settings,
  },
];
  ...
  return (
    <div className="min-h-screen flex bg-white dark:bg-background">
      ...
      <aside className="hidden md:flex w-[280px] shrink-0 flex-col bg-zinc-100 dark:bg-card fixed top-0 left-0 h-screen z-30">
        <div className="h-14 flex items-center px-3 shrink-0 bg-zinc-100 dark:bg-card">
          <Link
            href="/manage"
            className="flex items-center gap-2 px-2 py-1.5 rounded-lg text-sm font-medium text-muted-foreground dark:text-zinc-400 hover:bg-zinc-50 dark:hover:bg-zinc-800 hover:text-foreground dark:hover:text-white transition-colors"
          >
      ...
      {}
      <div className="flex-1 min-w-0 flex flex-col bg-white dark:bg-background md:ml-[280px]">
        {}
        <div className="md:hidden h-14 flex items-center px-3 shrink-0 bg-zinc-100 dark:bg-card">
          <Link
            href="/manage"
            className="flex items-center gap-2 px-2 py-1.5 rounded-lg text-sm font-medium text-muted-foreground dark:text-zinc-400 hover:bg-zinc-50 dark:hover:bg-zinc-800 hover:text-foreground dark:hover:text-white transition-colors"
          >
