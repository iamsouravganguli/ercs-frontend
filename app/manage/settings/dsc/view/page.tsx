  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden relative">
      <div className="flex flex-1 overflow-hidden h-full flex-col">
        {}
        <div className="sticky top-0 z-20 flex items-center justify-between h-14 px-6 bg-white dark:bg-background shrink-0 w-full">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6 no-scrollbar">
          <div className="space-y-6 max-w-xl mx-auto w-full">
            ...
            <section className="bg-card border rounded-xl overflow-hidden shadow-xs">
              <div className="px-6 py-3 bg-gradient-to-r from-[#f9f9f9] to-[#e4e4e7] dark:from-neutral-900 dark:to-neutral-950 text-sm font-semibold text-foreground">
        ...
        {}
        <div className="flex items-center justify-end border-t bg-white dark:bg-background px-8 py-3 z-10 relative">
